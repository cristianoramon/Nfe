...
function Header()
{
    ...
    $this->SetAuthor('Cooperativa R - Divisão de Sistemas e Métodos.');
    $this->SetSubject('Documento Auxiliar da Nota Fiscal Eletrônica.');
    ...
    $this->SetXY(35,19.5);
    $this->Cell(30,1.5,'IDENTIFICAÇÃO E ASSINATURA DO RECEBEDOR');
 ...
 //  Fim logotipo
    ...
    $this->SetXY(82.5,43);
    $this->Cell(30,2,'FISCAL ELETRÔNICA',0,0,'C');
    $this->SetXY(82.5,46.5);
    $this->Cell(30,2,'      1 - SAÍDA');
    ...
    $this->SetFont('Arial','',4.5);
//    $this->SetXY(115,38.5);
//    $this->Cell(30,1.5,'CONTRÔLE DO FISCO');
    ...
    $this->SetXY(5,64.5);
    $this->Cell(30,1.5,'NATUREZA DA OPERAÇÃO');
    $this->RoundedRect(5,70,35,6,0.7,'','134');
    $this->SetXY(5,70.5);
    $this->Cell(30,1.5,'INSCRIÇÃO ESTADUAL');
    $this->RoundedRect(40,70,39,6,0.7,'','34');
    $this->SetXY(40,70.5);
    $this->Cell(30,1.5,'INSC. ESTADUAL DO SUBS. TRIBUTÁRIO');
...
//    $this->SetXY(115,70.5);
  //  $this->Cell(30,1.5,'DADOS DA NF-e');
    ...
    $this->SetXY(10,85.5);
    $this->Cell(30,1.5,'ENDEREÇO');
    $this->SetXY(110,85.5);
    $this->Cell(30,1.5,'BAIRRO / DISTRITO');
    $this->SetXY(158,85.5);
    $this->Cell(15,1.5,'CEP');
    $this->SetXY(175,85.5);
    $this->Cell(30,1.5,'DATA DA SAÍDA / ENTRADA');
    ...
    $this->Cell(30,1.5,'INSCRIÇÃO ESTADUAL');
    $this->SetXY(175,91.5);
    $this->Cell(30,1.5,'HORA DA SAÍDA');
    $this->SetFont('Arial','',5);
    $this->SetXY(5,98);
    ...
    $this->SetFont('Arial','',4.5);
    $this->SetXY(5,100.5);
    $this->Cell(22.2,1.5,'NÚMERO',0,0,'C');
    ...
    $this->SetFont('Arial','',5);
    $this->SetXY(5,107);
    $this->Cell(30,1.5,'CÁLCULO DO IMPOSTO');
    ...
    $this->SetFont('Arial','',4.5);
    $this->SetXY(5,109.5);
    $this->Cell(30,1.5,'BASE DE CÁLCULO DO ICMS');
    $this->SetXY(45,109.5);
    $this->Cell(30,1.5,'VALOR DO ICMS');
    $this->SetXY(85,109.5);
    $this->Cell(40,1.5,'BASE DE CÁLCULO DO ICMS SUBSTITUIÇÃO');
    $this->SetXY(125,109.5);
    $this->Cell(30,1.5,'VALOR DO ICMS SUBSTITUIÇÃO');
    ...
    $this->Cell(30,1.5,'OUTRAS DESPESAS ACESSÓRIAS');
    ...
    $this->SetXY(95,128.2);
    $this->Cell(30,1.5,'2 - DESTINATÁRIO');
    $this->SetFont('Arial','',4.5);
    $this->SetXY(118.5,124.5);
    $this->Cell(30,1.5,'CÓDIGO ANTT');
    $this->SetXY(142,124.5);
    $this->Cell(30,1.5,'PLACA DO VEÍCULO');
   ...
   // $this->Cell(10,1.5,'UF');
    ...
    $this->SetFont('Arial','',5);
    $this->SetXY(5,146.5);
    $this->Cell(11,1.5,'CÓDIGO DO',0,0,'C');
    $this->SetXY(5,148.5);
    $this->Cell(11,1.5,'PRODUTO',0,0,'C');
    $this->SetXY(16,147.5);
    $this->Cell(48,1.5,'DESCRIÇÃO DO PRODUTO / SERVIÇO',0,0,'C');
    $this->SetXY(64,147.5);
    ...
    $this->Cell(15,1.5,'UNITÁRIO',0,0,'C');
    ...
    $this->SetXY(5,212);
    $this->Cell(30,1.5,'CÁLCULO DO ISSQN');
    ...
    $this->SetFont('Arial','',4.5);
    $this->SetXY(5,214.5);
    $this->Cell(30,1.5,'INSCRIÇÃO MUNICIPAL');
    $this->SetXY(55,214.5);
    $this->Cell(30,1.5,'VALOR TOTAL DOS SERVIÇOS');
    $this->SetXY(105,214.5);
    $this->Cell(30,1.5,'BASE DE CÁLCULO DO ISSQN');
    ...
    $this->SetFont('Arial','',4.5);
    $this->SetXY(5,223.5);
    $this->Cell(30,1.5,'INFORMAÇÕES COMPLEMENTARES');
    ...
    $this->RotatedText(85.5,284.5,'LÍQUIDO',0);
    $this->SetFont('Arial','',5);
    $this->RotatedText(205,289,'      -      D I V I S Ã O    D E    S I S T E M A S    E    M É T O D O S',90);
