...
<form action="AtualNotaCanc.php" name="form" method="post">
                      ...
                      <td width="82%">
                        <table width="616" height="120" border="0" align="left" cellpadding="0" cellspacing="0">
                          ...
                          <tr class="body">
                            ...
                            <td height="22">                          
                            <td height="22"><textarea name="txt_just" cols="50" rows="10" id="txt_just" style="border: 1 solid #00923f; background-Color:'#CBE4CB';" onFocus="style.backgroundColor='#CBE4CB'; style.color='black'" onBlur="style.backgroundColor='white'; style.color='black'" onMouseDown="ddrivetip('N&uacute;mero do Pedido', 300);" onMouseOut="hideddrivetip();"></textarea>
                          </tr>
                          <tr class="body">
