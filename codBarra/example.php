<a href="file:///Cc:/xamppWeb/htdocs/Barra/class/font/Arial.ttf">ddddd
</a>
<?php
#===========================================================================
#= Script : phpCode128
...
$barcode = new phpCode128('mikeleigh.com', 150, 'c:/xamppWeb/htdocs/Barra/class/font/Arial.ttf', 18);
...
$barcode = new phpCode128('200', 150,"c:/xamppWeb/htdocs/Barra/class/font/Arial.ttf", 18);
$barcode->setTextSpacing(20);
$barcode->setStartSet('C');
$barcode->saveBarcode('12.png');
...
echo "<img src='12.png'>";
echo "<hr />";
$barcode = new phpCode128('31071112229415001605550010000093860002214910', 100, "c:/xamppWeb/htdocs/Barra/class/font/Arial.ttf", 18);
$barcode->setEanStyle(false);
$barcode->setPixelWidth(1);
$barcode->setStartSet('C');
$barcode->setShowText(false);
$barcode->saveBarcode('13.png');
echo "<h3>Not using EAN style</h3>";
echo "<p>setEanStyle set to false</p>";
echo '<pre>
	$barcode->setBorderWidth(2);
