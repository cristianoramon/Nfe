...
function b_writeStyle() {
  ...
  document.write('text-color:white;background-image:url(../Figuras/botao2.jpg);}');
  
  //CSC Background
  document.write('.backFundo { background-image:url(../Figuras/fundo2.jpg);}'); 
...
var c=0;
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write(this.width+'px, '+h+'px, 0px); background-image:url(../Figuras/fundo10.jpg);">');
